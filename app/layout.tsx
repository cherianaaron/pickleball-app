  ...
  return (
    <html lang="en">
      <head>
        {/* Google Analytics */}
        <Script
          src="https://www.googletagmanager.com/gtag/js?id=G-MEWTXN5NLR"
        ...
        <Script id="google-analytics" strategy="afterInteractive">
          {`
            ...
            gtag('js', new Date());
            gtag('config', 'G-MEWTXN5NLR');
          `}
        </Script>
        {/* Google AdSense */}
        <Script
          async
          src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-9856496401783276"
